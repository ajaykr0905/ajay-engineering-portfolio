...
above 3:1. The final Axe run must independently confirm rendered text contrast.

## Automated checks completed

- Playwright: 35 passed, 7 intentional device-profile skips, 0 failed across desktop
...
- Input/media modes: fine-pointer hover, coarse-pointer non-hover behavior, forced
  colors, 200% page scale, and 360px/1024px horizontal-overflow checks.
...
- Lighthouse ran three times each on the homepage, experience page, and flagship
  project page: Performance 0.99, Accessibility 1.00, Best Practices 1.00, SEO 1.00
  in every run.
